 ...
 *
 */
public class CopyOfTimelineFragment extends Fragment implements Observer {
	private Model model;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		totalTweetsData = (TextView) rootView.findViewById(R.id.totalTweetsData);
		totalFollowersData = (TextView) rootView
				.findViewById(R.id.totalFollowersData);
		totalFollowingData = (TextView) rootView
				.findViewById(R.id.totalFollowingData);
